...
void processing ()
{
   ...
   // ************* Segmenting the weld piece ***************** //    
    ...
    sr.setLeafSize (0.007, 0.007, 0.007);
...
void cloudViewer(const std_msgs::Float32ConstPtr& number)
{
    if(a==0)
    {
        ...
        visualizer->addPointCloud (cloud_plane, "cloud");
        visualizer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2, "cloud");

        pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> c1 (cloud_cluster1, 0, 255, 0);
        ...
        pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> wl (segmented_edge, 255, 255, 255);
        visualizer->addPointCloud (segmented_edge, wl, "weld");
        visualizer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2, "weld");
    ...
    visualizer->updatePointCloud (cloud_plane, "cloud");
